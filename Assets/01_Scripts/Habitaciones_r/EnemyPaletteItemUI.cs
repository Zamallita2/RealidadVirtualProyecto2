...
public class EnemyPaletteItemUI : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    [Header("UI")]
    ...
    public void Setup(EnemyGachaData data, int copies, bool draggable)
    {
        ...
        if (copiesText != null)
            copiesText.text = "x" + copies;

        canvasGroup.alpha = draggable ? 1f : 0.45f;
